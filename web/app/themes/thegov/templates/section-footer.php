...
if (!class_exists('Thegov_footer_area')) {
	/**
	 * Footer area
	 *
	 *
	 * @class 		Thegov_footer_area
	 * @version		1.0
	 * @category	Class
	 * @author 		WebGeniusLab
	 */
    ...
    class Thegov_footer_area {
		...
		*/
    	...
    	function __construct () {
	        ...
	        $footer_bg_color = Thegov_Theme_Helper::get_option('footer_bg_color');
	        // copyright option
	        $copyright_switch = Thegov_Theme_Helper::get_option('copyright_switch');

			//add global variables
	        $this->footer_full_width = Thegov_Theme_Helper::get_option('footer_full_width');
	        ...
	        $style .= Thegov_Theme_Helper::bg_render('footer','mb_footer_switch','on');
    	...
    	private function get_wave_html(){
    		$wave_switch = Thegov_Theme_Helper::options_compare('footer_add_wave','mb_footer_switch','on');
    		if((bool) $wave_switch){

    			$wave_height = Thegov_Theme_Helper::get_option('footer_wave_height');
    			...
    			echo "<div class='thegov_wave_footer' style='height:".(int) $wave_height."px;'>";
    	...
    	private function get_footer_vars($optn_1 = null){
    		...
    		//Get options
			$footer_spacing = Thegov_Theme_Helper::options_compare('footer_spacing','mb_footer_switch','on');
			$footer_border = Thegov_Theme_Helper::options_compare('footer_add_border','mb_footer_switch','on');
			$footer_border_color = Thegov_Theme_Helper::options_compare('footer_border_color','mb_footer_switch','on');

	        // Only for widgets in footer
	        if ($optn_1 == 'widgets') {
				$footer_options['widget_columns'] = Thegov_Theme_Helper::get_option('widget_columns');
		        $footer_options['widget_columns_2'] = Thegov_Theme_Helper::get_option('widget_columns_2');
		        $footer_options['widget_columns_3'] = Thegov_Theme_Helper::get_option('widget_columns_3');
		        $footer_align = Thegov_Theme_Helper::get_option('footer_align');
	        ...
	        echo "<div class='footer_top-area' ".$footer_border_style.">";
                ...
                echo "<div class='row-footer'".$footer_style.">";
                    ...
                    if (!empty($footer_page_select)) {
                    	...
                    	$footer_page_select_id = thegov_dynamic_styles()->multi_language_support($footer_page_select_id, 'footer');
    	...
    	private function copyright_spacing(){
	        //Get options
    		$copyright_spacing = Thegov_Theme_Helper::options_compare('copyright_spacing','mb_copyright_switch','on');
    	...
    	private function copyright_style(){
			$bg_color = Thegov_Theme_Helper::options_compare('copyright_bg_color','mb_copyright_switch','on');
    	...
    	private function copyright_html() {
	        $editor = Thegov_Theme_Helper::get_option('copyright_editor');

	        if ($this->mb_copyright_switch == 'on') {
	        	$editor = rwmb_meta('mb_copyright_editor');
	        }
	        ?>
    		<div class='copyright'<?php echo Thegov_Theme_Helper::render_html($this->copyright_style()); ?> >
                <?php if (!$this->footer_full_width) echo "<div class='wgl-container'>"; ?>
                	<div class='row' <?php echo Thegov_Theme_Helper::render_html($this->copyright_spacing());?> >
